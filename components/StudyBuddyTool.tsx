...
export const StudyBuddyTool: React.FC = () => {
    ...
    useEffect(() => {
      const newChat = ai.chats.create({
          ...
          config: {
              systemInstruction: 'أنت مساعد دراسي ذكي. وظيفتك هي شرح المفاهيم المعقدة في الرياضيات، العلوم، واللغات بطريقة بسيطة ومفصلة. قدم أمثلة واضحة وشجع الطالب على الفهم. استخدم اللغة العربية.',
          },
      });
      setChat(newChat);
      setMessages([{role: 'model', text: 'أهلاً بك! أنا مساعدك الدراسي الذكي. كيف يمكنني مساعدتك اليوم؟'}]);
    }, []);
    ...
    return (
        <div className="flex flex-col h-[70vh]">
            <h2 className="text-2xl font-bold text-center text-amber-500 dark:text-amber-400 mb-4">المساعد الدراسي الذكي</h2>
            ...
            <div className="flex gap-2">
                <input
                    ...
                    placeholder="اطرح سؤالاً في الرياضيات، العلوم، أو اللغات..."
